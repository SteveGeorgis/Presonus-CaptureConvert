...
# First step is to identify and open the directory that contains the Capture data we want to process.
    ...
    if "Audio" in os.listdir() and os.path.isdir("Audio"):
        ...
        print("The 'Audio' sub-directory does not exist in this directory.")
        print(" - There must be an Audio subdirectory in the main Capture directory containing all the .wav audio source files.")
        sys.exit()  #end the program if the Audio folder doesn't exist.
...
#                   clear the link flag for this track
    ...
    print()
    print("Next update audio files names and make stereo files.  This will take a bit of time depending on the length and number of audio tracks ...")
    print()
